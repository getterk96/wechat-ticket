...
class CustomWeChatView(WeChatView):
    ...
    handlers = [
        HelpOrSubscribeHandler, UnbindOrUnsubscribeHandler, BindAccountHandler, BookEmptyHandler, #LoginHandler,
        GetActivityHandler, GetTicketHandler, CheckTicketHandler, ReturnTicketHandler,#, QuickResponseHandler
    ]
    error_message_handler = ErrorHandler
    default_handler = DefaultHandler
    event_keys = {
        'check_ticket': 'SERVICE_CHECK_TICKET',
        'account_bind': 'SERVICE_BIND',
        'help': 'SERVICE_HELP',
        'book_empty': 'BOOKING_EMPTY',
        'book_header': 'BOOKING_ACTIVITY_',
        'check_activities': 'SERVICE_CHECK_ACTIVITIES',
    }
                ...
                "sub_button": [
                    {
                        "type": "click",
                        "name": "抢啥",
                        "key": event_keys['check_activities'],
                    },
                    {
                        "type": "click",
                        "name": "查票",
                        "key": event_keys['check_ticket'],
                    },
                    {
                        "type": "click",
                        "name": "绑定",
